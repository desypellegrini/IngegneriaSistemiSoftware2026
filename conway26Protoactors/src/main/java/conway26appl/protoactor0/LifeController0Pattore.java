 ...
 */
public class LifeController0Pattore extends AbstractProtoactor26 {  
...
//		else 
		if (payload.equals("stop")) {
			...
			CommUtils.outblue(name + " | EXIT from:" + m.msgSender()  );
			IApplMessage closeCmd  = CommUtils.buildDispatch(name, "closeConnToGui", "do", "outdev"  );
			forward(closeCmd);
			System.exit(0);		 
		}
    }
