		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition( edgeName="goto",targetState="simulate", cond=doswitch() )
				}	 
				state("simulate") { //this:State
					action { //it:State
						...
						CommUtils.outblack("$name | emetto distanza $Dist")
						delay(3000) 
						//genTimer( actor, state )
					}
					//After Lenzi Aug2002
